...
public interface SalaryService {
    ...
    Double getMonthlySalary(Long employeeId, LocalDate startDate, LocalDate endDate);

    Integer getTotalClothForMonth(Long employeeId, LocalDate startDate, LocalDate endDate);
}
